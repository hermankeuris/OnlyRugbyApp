...
The functionality of the app will be spread between the following use cases:
	...
	\subsection{Scoring}
		...
		\begin{center}
	 	 	 \includegraphics[width=0.9\textwidth] {./images/game_menu.jpg}\\[0.4cm]
		\end{center}
		...
		\begin{center}
  			 \includegraphics[width=0.9\textwidth] {./images/choose_try_team.jpg}\\[0.4cm]
		\end{center}
		...
		\begin{center}
  			 \includegraphics[width=0.9\textwidth] {./images/choose_try_player.jpg}\\[0.4cm]
		\end{center}
			\item In most cases the user is then done entering the score information but in the case of a 'Try' more steps must be completed:
				...
				\begin{center}
  					 \includegraphics[width=0.9\textwidth] {./images/try_converted.jpg}\\[0.4cm]
				\end{center}
				\end{itemize}
		...
		\begin{center}
  			 \includegraphics[width=0.9\textwidth] {./images/score_increased.jpg}\\[0.4cm]
		\end{center}
		\end{enumerate}
	...
	\subsection{Substitutions}
		...
		\begin{enumerate}
			...
			\begin{center}
  				 \includegraphics[width=0.9\textwidth] {./images/choose_substitute.jpg}\\[0.4cm]
			\end{center}
			...
			\begin{center}
  				 \includegraphics[width=0.9\textwidth] {./images/choose_substitute_player.jpg}\\[0.4cm]
			\end{center}
	...
	On all of the above described pages the user also has the option of using the phone's  'Back' button which redirects the user to the previous page and ignores the information that was logged on the page it is now leaving.
		\begin{center}
  				 \includegraphics[width=0.9\textwidth] {./images/choose_substitute_off_field.jpg}\\[0.4cm]
			\end{center}
		\end{enumerate}
	...
	{\bfseries\{This section is still under development\}}\\ \\
		...
		\end{enumerate}
		\begin{center}
  			 \includegraphics[width=0.9\textwidth] {./images/choose_ruck_team.jpg}\\[0.4cm]
		\end{center}
	On all of the above described pages the user also has the option of using the phone's  'Back' button which redirects the user to the previous page and ignores the information that was logged on the page it is now leaving.
