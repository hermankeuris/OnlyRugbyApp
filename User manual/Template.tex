...
\begin {itemize}
	\item The user will run the app itself from a mobile device, such as a smart-phone or tablet using Android 4.0 or higher.
...
\end{itemize}
\begin{center}
  	 \includegraphics[width=1.0\textwidth] {./images/SystemConfiguration2.png}\\[0.4cm]
\end{center}
...
\begin {itemize}
	...
	\item Alternatively the user could go on GitHub \\(https://github.com/hermankeuris/OnlyRugbyApp/tree/master/Install) and download the application's APK directly (i.e. Only Rugby Score Keeper.apk). You can either download this through your mobile device's web browser directly or first download it on a computer and then copy the APK file to your android device through a USB connection with the computer.
	\begin{center}
  		 \includegraphics[width=1.0\textwidth] {./images/APKdownload.png}\\[0.4cm]
	\end{center}
	\item To allow your Android device to run this APK you will first have to enable your device to allow the installation of files from "unknown" sources. This is done by going to your device's Settings, then Security and checking the "Unknown Sources" checkbox.
	\begin{center}
...
The functionality of the app will be spread between the following use cases:
	...
	Usage:
	\begin{itemize}
		\item The game time is displayed at the top of the user interface.
