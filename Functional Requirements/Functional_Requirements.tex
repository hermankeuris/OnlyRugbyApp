...
\newpage
	...
	\item \textbf{Tackles}
		...
		\end{flushleft}
		\begin{center}
		%\includegraphics[width=1\textwidth]{../Diagrams/Tackles.jpg}\\[0.4cm]
		\end{center}
	\item \textbf{Possession}
		...
		\end{flushleft}
		\begin{center}
		%\includegraphics[width=1\textwidth]{../Diagrams/Possession.jpg}\\[0.4cm]
		\end{center}
	\item \textbf{Turn-overs}
		\begin{flushleft}
		This use case will be used to log the occurence of a turn-over, which team got the ball, which team lost the ball and the players who were involved in the turn-over.
		\end{flushleft}
		\begin{center}
...
\begin{itemize}
	\item Log in/ log out
		\begin{center}
  	 	%\includegraphics[width=1\textwidth] {../Diagrams/Login_LogoutActivityDiagram.jpg}\\[0.4cm]    
		\end{center}
	\item Load info
		\begin{center}
	...
	\item Discipline
		\begin{center}
		%\includegraphics[width=1\textwidth] {../Diagrams/DisciplineActivityDiagram.jpg}\\[0.4cm]
		\end{center}
\end{itemize}
