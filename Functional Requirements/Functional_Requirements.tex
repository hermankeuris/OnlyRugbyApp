...
player's profile. & This use case provides a way of quickly logging both the player's infraction and the card reveived.\\ \hline
    ...
    Scrums & The app must be aware that a match is currently being played and a list of all the players (both sides) currently on the field. It should also know the conditions for when a scrum can occur. & The scrum onwer and winner should be verified and statistics saved & This case provides a way to save statistics of a scrum and to see what percentage a team wins of their own scrums\\ \hline
