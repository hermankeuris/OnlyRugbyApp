    ...
    public void onCreateContextMenu(ContextMenu menu, View v,ContextMenu.ContextMenuInfo menuInfo) {
        ...
        switch (v.getId()) {
            ...
            case R.id.chronometer:
                if (!endOfGame) {
                    if (firstHalf && paused)
                        inflater.inflate(R.menu.gameclock_menu_paused, menu);
                    else if (firstHalf)
                        inflater.inflate(R.menu.gameclock_menu_unpaused, menu);
                    else if (paused)
                        inflater.inflate(R.menu.gameclock_menu_second_half_paused, menu);
                    else
                        inflater.inflate(R.menu.gameclock_menu_second_half_unpaused, menu);
                }
                break;
        }
